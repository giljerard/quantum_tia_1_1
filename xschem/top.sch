...
C {quantum_tia_1_1/xschem/core.sym} 810 -410 0 0 {name=x1}
...
C {quantum_tia_1_1/xschem/core.sym} 1670 -410 0 0 {name=x2}
...
C {quantum_tia_1_1/xschem/sf.sym} 2480 -430 0 0 {name=X1}
...
C {quantum_tia_1_1/xschem/cmfb.sym} 850 -1110 0 1 {name=x3}
...
C {quantum_tia_1_1/xschem/cmfb.sym} 1740 -1050 0 1 {name=x4}
C {quantum_tia_1_1/xschem/mirror_1.sym} 2180 -890 0 0 {name=x5}
...
C {quantum_tia_1_1/xschem/mirror_3.sym} 2720 -890 0 0 {name=x6}
...
C {quantum_tia_1_1/xschem/mirror_4.sym} 3290 -890 0 0 {name=x7}
...
C {xschem_sky130/sky130_fd_pr/cap_mim_m3_1.sym} 430 -290 1 0 {name=C5 model=cap_mim_m3_1 W=61.2 L=61.2 MF=1 spiceprefix=X}
C {xschem_sky130/sky130_fd_pr/cap_mim_m3_2.sym} 430 -330 3 0 {name=C6 model=cap_mim_m3_2 W=61.2 L=61.2 MF=1 spiceprefix=X}
C {xschem_sky130/sky130_fd_pr/cap_mim_m3_1.sym} 430 -60 1 0 {name=C7 model=cap_mim_m3_1 W=61.2 L=61.2 MF=1 spiceprefix=X}
C {xschem_sky130/sky130_fd_pr/cap_mim_m3_2.sym} 430 -100 3 0 {name=C8 model=cap_mim_m3_2 W=61.2 L=61.2 MF=1 spiceprefix=X}
...
C {devices/ngspice_probe.sym} 2330 -910 2 1 {name=r1}
C {devices/launcher.sym} 1530 -820 0 0 {name=h1
descr='tate
