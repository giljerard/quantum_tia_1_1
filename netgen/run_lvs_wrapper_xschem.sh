...
netgen -batch lvs "user_analog_project_wrapper.spice user_analog_project_wrapper_new" "../xschem/user_analog_project_wrapper_sch.spice user_analog_project_wrapper" /usr/local/share/pdk/sky130A/libs.tech/netgen/sky130A_setup.tcl comp.out
